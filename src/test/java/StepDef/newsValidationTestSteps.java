...
public class newsValidationTestSteps {
    ...
    public void userLandsOnTheNewsValidationNewsSite() {
    }
    ...
    public void userValidatesThatNoArticlesAreFoundOnGoogleSource() {

    }

    @And("user considers the first news article as invalid")
    public void userConsidersTheFirstNewsArticleAsInvalid() {
